...
**How to apply:** Run the lockfile-based workspace install, confirm the resolved Expo line, then restart the managed Expo workflow before judging runtime behavior.
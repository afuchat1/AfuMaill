...
function Field({
  ...
  return (
    <View style={f.wrap}>
      ...
      <View style={[
        f.inputWrap,
        { backgroundColor: focused ? W.bgSelected : W.bgSecondary },
      ]}>
        <TextInput
...
function PrimaryBtn({ label, onPress, loading, disabled, icon }: {
  ...
  return (
    <Pressable
      ...
      style={[
        pb.root,
        { backgroundColor: disabled ? W.bgSecondary : hovered ? W.accentHover : W.accent, opacity: loading ? 0.8 : 1 },
      ]}
    >
      {loading ? <ActivityIndicator size="small" color="#fff" /> : (
        <>
          <Text style={[pb.label, { fontFamily: "Inter_700Bold", color: disabled ? W.textMuted : "#fff" }]}>{label}</Text>
          {icon && <Feather name={icon} size={15} color={disabled ? W.textMuted : "#fff"} />}
        </>
      )}
    </Pressable>
  );
      ...
      {Array.from({ length: total }).map((_, i) => (
        <View
          ...
          style={{
            ...
            backgroundColor: i < current ? W.accent : W.bgSecondary,
          }}
        />
      ))}
    </View>
...
function ErrorBox({ msg }: { msg: string }) {
  return (
    <View style={[eb.root, { backgroundColor: W.destructiveLight }]}>
...
const eb = StyleSheet.create({
  root: { flexDirection: "row", alignItems: "center", gap: 8, padding: 10, borderRadius: 8 },
  ...
  return (
    <View style={[styles.root, { backgroundColor: W.bg }]}>
      ...
      >
        ...
        {/* Card */}
        <View style={[styles.card, { backgroundColor: W.bgCard }]}>
          ...
          {mode === "login" && (
            <View style={styles.form}>
              ...
              <View style={[styles.divider, { borderTopColor: W.borderLight }]}>
              ...
              <Pressable
                ...
                style={({ pressed, hovered }: any) => [
                  styles.outlineBtn,
                  { backgroundColor: pressed || hovered ? W.bgHover : W.bgSecondary },
                ]}
              >
                  ...
                  <View style={styles.fields}>
                    ...
                    <View style={styles.twoCol}>
                      <Pressable
                        ...
                        style={({ pressed, hovered }: any) => [
                          styles.outlineBtn,
                          { flex: 1, backgroundColor: pressed || hovered ? W.bgHover : W.bgSecondary },
                        ]}
                      >
                        <Text style={[styles.outlineBtnLabel, { fontFamily: "Inter_600SemiBold", color: W.textPrimary }]}>
        ...
        {/* Footer domain */}
        <Text style={[styles.footer, { fontFamily: "Inter_400Regular", color: W.textMuted }]}>
...
const styles = StyleSheet.create({
  ...
  formHeader: { gap: 6 },
  formTitle: { fontSize: 24, letterSpacing: -0.5 },

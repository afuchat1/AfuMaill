...
const FAQ = [
  ...
  },
  {
    ...
    a: "A recovery email is an existing @afuchat.com address linked to your profile. It receives AfuMail password reset codes if you ever get locked out. Keep it up to date in Settings → Account Recovery.",
  },
  {

-- Resolve display names for AfuMail senders without exposing the whole
-- profiles table. Only names for addresses visible in the caller's mailbox
-- can be returned.

begin;

create or replace function public.get_afuchat_sender_display_names(_emails text[])
